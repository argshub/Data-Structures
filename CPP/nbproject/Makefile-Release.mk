...
${OBJECTDIR}/CircularLinkedListTest.o: CircularLinkedListTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CircularLinkedListTest.o CircularLinkedListTest.cpp

${OBJECTDIR}/DequeTest.o: DequeTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DequeTest.o DequeTest.cpp

${OBJECTDIR}/DoublyLinkedListTest.o: DoublyLinkedListTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DoublyLinkedListTest.o DoublyLinkedListTest.cpp

${OBJECTDIR}/ParallelArrayTest.o: ParallelArrayTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParallelArrayTest.o ParallelArrayTest.cpp
...
${OBJECTDIR}/SinglyLinkedListTest.o: SinglyLinkedListTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SinglyLinkedListTest.o SinglyLinkedListTest.cpp

${OBJECTDIR}/StackTest.o: StackTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StackTest.o StackTest.cpp
