...
${OBJECTDIR}/BitArrayTest.o: BitArrayTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitArrayTest.o BitArrayTest.cpp
...
${OBJECTDIR}/QueueTest.o: QueueTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QueueTest.o QueueTest.cpp

${OBJECTDIR}/SetTest.o: SetTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SetTest.o SetTest.cpp

${OBJECTDIR}/SinglyLinkedListTest.o: SinglyLinkedListTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SinglyLinkedListTest.o SinglyLinkedListTest.cpp

${OBJECTDIR}/StackTest.o: StackTest.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StackTest.o StackTest.cpp
